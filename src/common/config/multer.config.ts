...
export const isValidVideoDuration = (filePath: string, maxSeconds = 60): Promise<boolean> => {
...
export { storage, upload, uploadExcel, uploadCSV, uploadPDF, checkFileType, checkPDFFileType }
// export { upload }